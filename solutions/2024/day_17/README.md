...
incrementing A by smaller and smaller values until the desired output is reached.
...
Notice how as the power (n) decreases, the last 14 - n digits do not change. Thus, my program just increments A by 8 ** n, then when the last 15 - n digits of the output match the program, n is decremented. 